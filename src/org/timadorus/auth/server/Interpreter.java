...
public class Interpreter {
  ...
  private void help() {
    ...
    os.println(" Creates a new principal with the specified password.");
    os.println("user.edit <name> <password>");
    os.println(" Sets a new password for the principal with the specified name.");
    os.println("user.delete <name>");
    os.println(" Deletes the principal with the specified name.");
    os.println("user.exists <name>");
    os.println(" Determines whether the specified principal exists in the auth table.");
